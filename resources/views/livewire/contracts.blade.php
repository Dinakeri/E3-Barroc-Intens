                            ...
                            <tr onclick="window.location='{{ route('contracts.show', $contract) }}'"
                                ...
                                <td class="px-4 py-3">
                                    @if ($contract->pdf_path)
                                        <flux:button href="{{ Storage::url($contract->pdf_path) }}" variant="ghost"
                                            target="_blank" icon:trailing="arrow-up-right"
                                            onclick="event.stopPropagation();">
                                            Open PDF
                                        </flux:button>
                                    @else
                                        <div class="text-zinc-900 dark:text-zinc-100">Geen contract</div>
                                    @endif
                                </td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="text-sm text-zinc-900 dark:text-zinc-100 truncate max-w-[200px]">
                                        {{-- @if ($contract->customer->quote && $contract->customer->quote->url)
                                            <flux:button href="{{ $contract->customer->quote->url }}" variant="ghost"
                                                target="_blank" icon:trailing="arrow-up-right"
                                                onclick="event.stopPropagation();">
                                                Open PDF
                                            </flux:button>
                                ...
                                <td class="px-4 py-3">
                                    <flux:button wire:click.stop="showCustomerDetails({{ $contract->customer }})"
